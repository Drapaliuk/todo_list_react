...
export function DateOption({onSave, placeholder, Icon, initialDate = ''}) {
    ...
    return (
        <li class="todo-additional-option__time-options-item">
            <div class="todo-due-date todo-remind">
                ...
                <Calendar placeholder = {placeholder} onSave = {onSave} customInput = {CustomInput} initialDate = {initialDate} />
